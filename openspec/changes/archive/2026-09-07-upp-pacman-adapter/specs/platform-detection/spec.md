...
**Linux catalog**: apt, brew, pacman, nvm, npm, pnpm, bun, gh(→apt), docker(→apt), go, opencode
...
(Previously: the Linux catalog did not include `pacman`; manager entries were apt, brew, winget, scoop.)
