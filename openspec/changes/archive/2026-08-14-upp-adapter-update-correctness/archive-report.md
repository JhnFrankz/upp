...
| Action Context Guard | `actionContext.mode: repo-local` (not workspace-planning); `allowedEditRoots: [/home/jhan/projects/upp]` — all operations inside the repo root |
