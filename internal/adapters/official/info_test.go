...
func TestInfo(t *testing.T) {
	...
	tests := []infoCase{
		{"apt", func() adapters.Adapter { return &AptAdapter{} }, adapters.ToolInfo{ID: "apt", Name: "APT Package Manager", Platforms: []string{"linux"}, Trust: security.TrustOfficial, UpdatePolicy: adapters.PolicyGated, Kind: adapters.KindManager, SelfUpdateCommand: aptSelfUpdateCmd, PackageUpdateCommand: aptPackageUpdateTemplate}},
		{"brew", func() adapters.Adapter { return &BrewAdapter{} }, adapters.ToolInfo{ID: "brew", Name: "Homebrew", Platforms: []string{"linux", "macos"}, Trust: security.TrustOfficial, UpdatePolicy: adapters.PolicyAlwaysUpdate, Kind: adapters.KindManager, SelfUpdateCommand: brewSelfUpdateCmd, PackageUpdateCommand: brewPackageUpdateTemplate}},
		{"pacman", func() adapters.Adapter { return &PacmanAdapter{} }, adapters.ToolInfo{ID: "pacman", Name: "Pacman Package Manager", Platforms: []string{"linux"}, Trust: security.TrustOfficial, UpdatePolicy: adapters.PolicyGated, Kind: adapters.KindManager, Privileges: []string{"sudo"}, SelfUpdateCommand: pacmanSelfUpdateCmd, PackageUpdateCommand: pacmanPackageUpdateTemplate}},
		{"npm", func() adapters.Adapter { return &NpmAdapter{} }, adapters.ToolInfo{ID: "npm", Name: "npm", Platforms: []string{"linux", "macos", "windows"}, Trust: security.TrustOfficial, UpdatePolicy: adapters.PolicyGated, Kind: adapters.KindTool, Command: "npm update -g"}},
		{"pnpm", func() adapters.Adapter { return &PnpmAdapter{} }, adapters.ToolInfo{ID: "pnpm", Name: "pnpm", Platforms: []string{"linux", "macos", "windows"}, Trust: security.TrustOfficial, UpdatePolicy: adapters.PolicyGated, Kind: adapters.KindTool, Command: "pnpm update -g"}},
		...
		{"nvm", func() adapters.Adapter { return &NVMAdapter{} }, adapters.ToolInfo{ID: "nvm", Name: "Node Version Manager", Platforms: []string{"linux", "macos", "windows"}, Trust: security.TrustOfficial, UpdatePolicy: adapters.PolicyGated, Kind: adapters.KindTool, Command: "bash -c 'source \"${NVM_DIR:-$HOME/.nvm}/nvm.sh\" >/dev/null 2>&1 && nvm install --lts'"}},
		{"uv", func() adapters.Adapter { return &UvAdapter{} }, adapters.ToolInfo{ID: "uv", Name: "uv", Platforms: []string{"linux", "macos", "windows"}, Trust: security.TrustOfficial, UpdatePolicy: adapters.PolicyGated, Kind: adapters.KindTool, Command: "uv self update"}},
	}
